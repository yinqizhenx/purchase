...
func NewGRPCServer(c config.Config, logger log.Logger, svc *app_service.Service) *grpc.Server {
...
func registerServer(s ggrpc.ServiceRegistrar, srv *app_service.Service) {
