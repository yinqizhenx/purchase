...
type IdempotentMutation struct {
	...
	oldValue      func(context.Context) (*Idempotent, error)
	predicates    []predicate.Idempotent
}

var _ ent.Mutation = (*IdempotentMutation)(nil)

// idempotentOption allows management of the mutation configuration using functional options.
type idempotentOption func(*IdempotentMutation)

// newIdempotentMutation creates new mutation for the Idempotent entity.
func newIdempotentMutation(c config, op Op, opts ...idempotentOption) *IdempotentMutation {
	m := &IdempotentMutation{
		config:        c,
		op:            op,
		typ:           TypeIdempotent,
		clearedFields: make(map[string]struct{}),
...
// withIdempotentID sets the ID field of the mutation.
func withIdempotentID(id int64) idempotentOption {
	return func(m *IdempotentMutation) {
		var (
			err   error
			once  sync.Once
			value *Idempotent
		)
		m.oldValue = func(ctx context.Context) (*Idempotent, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().Idempotent.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withIdempotent sets the old Idempotent of the mutation.
func withIdempotent(node *Idempotent) idempotentOption {
	return func(m *IdempotentMutation) {
		m.oldValue = func(context.Context) (*Idempotent, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m IdempotentMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m IdempotentMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of Idempotent entities.
func (m *IdempotentMutation) SetID(id int64) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *IdempotentMutation) ID() (id int64, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *IdempotentMutation) IDs(ctx context.Context) ([]int64, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().Idempotent.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
func (m *IdempotentMutation) Key() (r string, exists bool) {
	v := m.key
	if v == nil {
		return
	}
...
// OldKey returns the old "key" field's value of the Idempotent entity.
// If the Idempotent object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *IdempotentMutation) OldKey(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
// SetCreatedAt sets the "created_at" field.
func (m *IdempotentMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *IdempotentMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the Idempotent entity.
// If the Idempotent object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *IdempotentMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *IdempotentMutation) ResetCreatedAt() {
	m.created_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *IdempotentMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *IdempotentMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the Idempotent entity.
// If the Idempotent object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *IdempotentMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdatedAt resets all changes to the "updated_at" field.
func (m *IdempotentMutation) ResetUpdatedAt() {
	m.updated_at = nil
}

// Where appends a list predicates to the IdempotentMutation builder.
func (m *IdempotentMutation) Where(ps ...predicate.Idempotent) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the IdempotentMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *IdempotentMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.Idempotent, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *IdempotentMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *IdempotentMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (Idempotent).
func (m *IdempotentMutation) Type() string {
	return m.typ
}
...
func (m *IdempotentMutation) Fields() []string {
	...
	if m.updated_at != nil {
		fields = append(fields, idempotent.FieldUpdatedAt)
	}
	return fields
}
...
func (m *IdempotentMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	...
	return nil, fmt.Errorf("unknown Idempotent field %s", name)
}
...
func (m *IdempotentMutation) SetField(name string, value ent.Value) error {
	...
	return fmt.Errorf("unknown Idempotent field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *IdempotentMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *IdempotentMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *IdempotentMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown Idempotent numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *IdempotentMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *IdempotentMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *IdempotentMutation) ClearField(name string) error {
	return fmt.Errorf("unknown Idempotent nullable field %s", name)
}
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *IdempotentMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *IdempotentMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *IdempotentMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *IdempotentMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *IdempotentMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *IdempotentMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *IdempotentMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown Idempotent unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *IdempotentMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown Idempotent edge %s", name)
}
