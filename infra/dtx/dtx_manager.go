...
var StepTest = []*TransSagaStep{
	{
		...
		Depend:            nil,
		ActionPayload:     []byte("s12"),
		CompensatePayload: []byte("a"),
	},
	{
		Name:              "step2",
		Action:            "step2_action",
	...
	},
	{
		...
		Depend:            []string{"step1"},
		ActionPayload:     []byte("s4343ss"),
		CompensatePayload: []byte("b"),
	},
	{
		Name:              "step4",
		Action:            "step4_action",
		...
		Depend:            []string{"step2"},
		ActionPayload:     []byte("555"),
		CompensatePayload: []byte("c"),
	},
	{
		Name:       "step5",
		Action:     "step5_action",
		...
		// Depend:     []string{"step5"},
		ActionPayload:     []byte("sdss"),
		CompensatePayload: []byte("d"),
	},
}
